...
module.exports = (robot) ->
  ...
  # Returns the number of a day of the week from a supplied string. Will only
  # attempt to match the first 3 characters. Sat/Sun currently aren't supported
  # by the cron but are included to ensure indexes are correct.
  getDayOfWeek = (day) ->
    if (!day)
      return -1
  ...
  # Check for standups that need to be fired, once a minute Monday to Friday.
