...
module.exports = (robot) ->
  ...
  # Compares the current time to the time of the standup to see if it should be
  # fired or not.
  ...
  # Finds the room for most adapters.
  findRoom = (msg) ->
  ...
  # Clears all the standups in a room.
  ...
  # Clears a specific standup in a room.
